...
# environment
export PATH="/opt/local/libexec/gnubin:/opt/local/bin:/opt/local/sbin:/usr/local/bin:/usr/local/sbin:/bin:/sbin:/usr/bin:/usr/sbin:/usr/games/bin:${PATH}"
export MANPATH="/opt/local/share/man:/usr/local/man:/usr/share/man:${MANPATH}"
